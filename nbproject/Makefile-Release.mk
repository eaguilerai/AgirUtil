...
${OBJECTDIR}/source/agir/ui/console/menu.o: source/agir/ui/console/menu.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/agir/ui/console/menu.o source/agir/ui/console/menu.cpp

${OBJECTDIR}/source/agir/ui/console/menu_option.o: source/agir/ui/console/menu_option.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/agir/ui/console
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/agir/ui/console/menu_option.o source/agir/ui/console/menu_option.cpp

${OBJECTDIR}/tests/agir/ui/console/menu.o: tests/agir/ui/console/menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/tests/agir/ui/console
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/agir/ui/console/menu.o tests/agir/ui/console/menu.cpp
...
${TESTDIR}/tests/agir/ui/console/menu.o: tests/agir/ui/console/menu.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/agir/ui/console/menu.o tests/agir/ui/console/menu.cpp


${TESTDIR}/tests/runner.o: tests/runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runner.o tests/runner.cpp
...
${OBJECTDIR}/source/agir/ui/console/menu_nomain.o: ${OBJECTDIR}/source/agir/ui/console/menu.o source/agir/ui/console/menu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/agir/ui/console/menu_nomain.o source/agir/ui/console/menu.cpp;\
	else  \
...
${OBJECTDIR}/source/agir/ui/console/menu_option_nomain.o: ${OBJECTDIR}/source/agir/ui/console/menu_option.o source/agir/ui/console/menu_option.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/agir/ui/console/menu_option_nomain.o source/agir/ui/console/menu_option.cpp;\
	else  \
...
${OBJECTDIR}/tests/agir/ui/console/menu_nomain.o: ${OBJECTDIR}/tests/agir/ui/console/menu.o tests/agir/ui/console/menu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/agir/ui/console/menu_nomain.o tests/agir/ui/console/menu.cpp;\
	else  \
